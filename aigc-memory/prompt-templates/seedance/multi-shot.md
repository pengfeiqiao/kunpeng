...
1. 写镜头前先确认本段的**事件主体、触发动作、可见结果**。三项必须进入镜头正文，不能被光影、材质或环境描写挤掉。
2. 司机、乘客、店员、保安、路人等功能角色只要参与事件，就按人物主体处理；不能把“司机在公路遇到事故”改写成只有道路、汽车外观和尘土的空镜。
3. 空镜只用于必要的空间建立、地点/时间转换、线索、事件余波或结果状态。禁止连续两条空镜，建立镜头结束后应尽快进入人物动作或反应。
4. 景别跟随信息距离变化，不机械套远→中→近→特写。远景/全景负责空间和规模，中景/过肩负责人物关系与完整动作，近景负责表演反应，特写/大特写只负责关键触点、线索或情绪峰值。两个以上子镜头不能全部是远景/全景，也不能全部是近景/特写。
5. 前一镜已经建立空间，当前镜可直接从事件人物、动作触发点或反应开始，不必每镜重复大全景。
6. 连续两条大特写必须有明确的线索递进、匹配剪辑、动作连接或先细节后揭示；连续三条近景/特写必须补回关系镜头。多人物事件至少要有一个中景、过肩、双人同框或其它能看清人物关系的镜头。
7. 电影级细节是表达层，不是剧情层。可丰富机位、焦点、光影、材质与微表演，不得新增原文没有的人物、对白、关系、关键行为或剧情结果。
...
- 表演层次：情绪按"触发→发酵→释放"时间轴推进（凝固/瞳孔/呼吸变化 → 下意识小动作 → 表情峰值与身体和解），禁止开关式瞬变；面部+呼吸躯干+手部重心三层联动
- 行为目的：主要动作写清角色此刻动机（想隐藏/确认/靠近/疏远什么），按性格锚点演出差异，强度匹配剧情量级
- 默认禁止 AI 短剧/漫剧风：瞪眼、嘶吼、嚎啕大哭、夸张甩头跺脚、邪魅坏笑、表情包式脸谱化表演（除非用户明确要求该风格）

## 画质 / 风格 / 约束词（片尾必带）

- 画质：高清，细节丰富，电影质感，光影柔和
- 风格：统一美术调性（项目风格串）
- 约束词：`保持无字幕` / `不要生成Logo` / `不要生成水印` / 明确目标风格防漂移 / `人物面部稳定不变形，无穿模无卡顿` / `表演克制真实，无瞪眼嘶吼等夸张程式化表情`
